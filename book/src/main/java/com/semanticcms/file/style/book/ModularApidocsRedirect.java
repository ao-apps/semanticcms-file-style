...
package com.semanticcms.file.style.book;
...
@WebServlet("/file/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/file/style/apidocs/com.semanticcms.file.style/com" + Objects.toString(req.getPathInfo(), ""),
